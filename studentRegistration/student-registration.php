...
<head>
    ...
    <link rel="stylesheet" href="./student-registrationstyle.css">
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body p-4">
                <form class="row g-1" action="./student-registerprocess.php" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="col-6">
                            ...
                            <input type="email" class="form-control" id="guardian-email" name="guardian-email" required />
                        </div>
                        <div class="col-md-6">
                            <label for="guardian-number" class="form-label">Guardian's Phone Number</label>
                            <input type="number" name="guardian-number" max="99999999999999" class="form-control" id="guardian-number" required />
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="image" name="image" class="form-label">Select Profile image</label>
                            <input type="file" class="form-control" id="image" name="image" />
                        </div>
                        <div class="col-md-6">
                            <input style="width: 100%;" type="submit" class="btn btn-primary" name="add-student" value="Add Student" />
                        </div>
                        <div class="col-md-6">
                            <input style="width: 100%;" type="reset" class="btn btn-danger" name="add-student" value="Reset Form" />
                        </div>
